...
/*			
		...
		*/
			...
			if (option.generatePagination) {
				// create unordered list
				if($('.' + option.next ,elem).length){
					$('.' + option.next ,elem).before('<div id="controllers"><ul class='+ option.paginationClass +'></ul></div>');
				}else
				if (option.prependPagination){
					elem.prepend('<div id="controllers"><ul class='+ option.paginationClass +'></ul></div>');
				}else{
					elem.append('<div id="controllers"><ul class='+ option.paginationClass +'></ul></div>');
				}
				// for each slide create a list item and link
				control.children().each(function(){
					$('.' + option.paginationClass, elem).append('<li><a href="#'+ number +'">'+ (number+1) +'</a></li>');
